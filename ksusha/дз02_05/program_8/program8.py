...
while True:
    print(
        ...
        "\n2. Добавить информацию о новом сотруднике в JSON-файл\n"
        "3. Добавить информацию о новом сотруднике в CSV-файл\n4. Вывести информацию об "
        "одном сотруднике по имени\n"
        "5. Вывести список всех сотрудников, кто владеет заданным языком программирования"
        "(язык вводит"
        "ся с клавиатуры)\n"
        "6. Вывести средний рост сотрудников, которые "
