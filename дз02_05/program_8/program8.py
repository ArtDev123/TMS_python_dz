...
def middle_height(json_path):
    ...
    for i in data:
        if year == i["birthday"][-4:]:
            ...
            sum_height += i["height"]
    if count == 0:
        print(f"Нет сотрудников, родившихся в {year} году")
    else:
...
while True:
    print(
        ...
        "4. Добавить информацию о новом сотруднике в CSV-файл\n5. Вывести информацию об одном сотруднике по имени\n"
        "6. Вывести список всех сотрудников, кто владеет заданным языком программирования(язык вводится с клавиатуры)\n"
        "7. Вывести средний рост сотрудников с заданным годом рождения(год вводится с клавиатуры)\n"
